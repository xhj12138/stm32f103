...
#include "./BSP/MPU6050/mpu6050.h"                    /* 包含相关头文件 */
#include "./SYSTEM/delay/delay.h"
#include "./BSP/MPU6050/eMPL/inv_mpu_dmp_motion_driver.h"
#define i2c_write   mpu6050_write                           /* IIC写通讯函数 */
#define i2c_read    mpu6050_read                            /* IIC读通讯函数 */
#define delay_ms    delay_ms                                /* 毫秒级延时函数 */
#define get_ms      mpu6050_get_clock_ms                    /* 获取毫秒级时间戳函数 */
